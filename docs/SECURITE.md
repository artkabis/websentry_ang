...
| --- | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| 1   | Injection SQL                 | 6 charges classiques n'authentifient ni n'altèrent l'état ; chaque repository vérifié sur la séparation requête/paramètres  | OWASP §1 + `*.repository.spec.ts`                                            |
...
| 5   | Contrôle d'accès défaillant   | Fermé par défaut, `ws_role` non falsifiable, IDOR impossible sur `/auth/me`, élévation refusée                              | OWASP §5 + `*.guard.spec.ts`                                                 |
